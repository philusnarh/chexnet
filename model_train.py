...
n_valid_samples = 100
train_filenames = filenames[n_valid_samples:601]
...
def model_fit():
    ...
    hist = model.fit_generator(train_gen, validation_data=valid_gen, callbacks=[learning_rate], epochs=100, shuffle=True)
...
folder = '/content/pneumonia-data/stage_1_test_images'
